    ...
    return (
        <div id="development">
            ...
            <div className="default-offset">
                <div>
                    <p>
                        The first major API access point is the <span className="endpoint">"/Public/Menu"</span> access point. This public access point can be used to retreive a user menu in its entirety, including the categories with their contained items, and items with the categories they belong to.
                ...
                <div>
                    ...
                    <Collapsible
                        ...
                        >
                        <center>
                            <iframe src="https://fhict-ordio.github.io/general/#/Public/get_Menu_" name="myiFrame" scrolling="yes" frameBorder="0" marginHeight="0px" marginWidth="0px" height="600px" width="100%" allowFullScreen />
                        </center>
                    </Collapsible>
                    {
                        !swaggerOpen &&
